...
const navItems = [
  ...
  { title: "Hồ sơ khám", href: "/admin/exams", icon: ClipboardList },
  { title: "Nhân viên", href: "/admin/employees", icon: Stethoscope },
  { title: "Khoa", href: "/admin/departments", icon: Building2 },
  { title: "Lịch làm việc", href: "/admin/schedules", icon: Calendar },
  ...
  { title: "Kết quả XN", href: "/admin/lab-results", icon: Microscope },
